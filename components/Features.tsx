...
export function Features() {
  return (
    <section id="services" className="border-y border-sand/70 bg-white py-12 sm:py-14 max-[999px]:border-0 max-[999px]:px-4 max-[999px]:pt-1 max-[999px]:pb-4">
      <div className="features-grid mx-auto grid max-w-[1200px] gap-8 px-6 sm:grid-cols-2 min-[1000px]:grid-cols-4 min-[1000px]:gap-6 min-[1000px]:px-8 max-[999px]:grid-cols-1 max-[999px]:gap-0 max-[999px]:rounded-2xl max-[999px]:bg-white max-[999px]:px-0 max-[999px]:shadow-sm">
        {features.map((feature) => (
          <article
            key={feature.title}
            className="feature-item flex items-start gap-3.5 text-left max-[999px]:items-center max-[999px]:gap-3 max-[999px]:border-b max-[999px]:border-ink/25 max-[999px]:px-4 max-[999px]:py-3.5 max-[999px]:last:border-b-0"
          >
