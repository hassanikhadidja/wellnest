...
export function ebooksPageUi(language?: string | null) {
  if (contentLanguage(language) === "ar") {
    return {
      ...
      categories: {
        Tous: "الكل",
        "Petit-déjeuner": "الإفطار",
        "Lunch Box": "لانش بوكس",
        "Déjeuners équilibrés": "وجبات غداء متوازنة",
        "Desserts sains": "حلويات صحية",
        "Boissons saines": "مشروبات صحية",
        "Fruits & Smoothies": "فواكه وسموذي",
        "Options végétariennes": "خيارات نباتية",
        "Repas protéinés": "وجبات بروتينية",
        "Menus pour enfants": "قوائم للأطفال",
      } as Record<string, string>,
      sortFilters: {
        recent: "الأحدث",
  ...
  return {
    ...
    categories: {
      ...
      "Lunch Box": "Lunch Box",
      "Déjeuners équilibrés": "Déjeuners équilibrés",
      "Desserts sains": "Desserts sains",
      "Boissons saines": "Boissons saines",
      "Fruits & Smoothies": "Fruits & Smoothies",
      "Options végétariennes": "Options végétariennes",
      "Repas protéinés": "Repas protéinés",
      "Menus pour enfants": "Menus pour enfants",
    } as Record<string, string>,
    sortFilters: {
